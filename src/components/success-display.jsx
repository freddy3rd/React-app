    ...
    return (
        <>
          ...
          className="container grid justify-center items-center bg-white relative h-[100vh] p-5 min-w-md md:max-h-[450px] md:max-w-md md:rounded-3xl md:p-10 md:shadow-2xl ">
            ...
            <button onClick={resetEmail} className=" py-3 mt-8 bg-[#242742] text-white rounded-lg font-semibold hover:bg-gradient-to-r from-[#FE49B2] from-83.48% to-[#FF6257]">Dismiss message</button>
          </motion.div>
        </>
    )
}