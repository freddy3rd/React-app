...
export default function Form({onSubmit}){
    ...
    return (
        <>
            <form onSubmit={onHandleSubmit} action="/success" className="grid mt-12 relative" >
                ...
                <button  className="flex justify-center py-3 mt-3 bg-[#242742] text-white rounded-lg font-semibold hover:bg-gradient-to-r from-[#FE49B2] from-83.48% to-[#FF6257]" >Subscribe to monthly newsletter</button>
            </form>
